  ...
  useEffect(() => {
    const fetchPHDPassouts = async () => {
      try {
        ...
        const response = await axios.get("/phd/get_phdpassout", {
          headers: {
            ...
            phdpassouts.map((passout) => (
              ...
              >
                <div className="mb-4">
                  ...
                  <p className="text-sm text-gray-500"><div className="text-base font-medium text-black">Theises Title </div>{passout.thesis_title || "N/A"}</p>
                ...
                <div className="flex justify-end space-x-2 mt-4">
                  <button
                    onClick={() => navigate(`/phdpassout/update/${passout._id}`)}
